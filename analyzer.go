...
func (a *Analyzer) skipDirectives(file *ast.File) (res *ast.CommentGroup, skip bool) {
	...
	var canSkip = strings.HasPrefix(file.Comments[lastCommentIndex].Text(), "Code generated by cmd/cgo")
...
func (a *Analyzer) Analyze(path string, file *ast.File) (*analysis.Diagnostic, error) {
	...
	var comment, skip = a.skipDirectives(file)
